...
## LLM-Einsatzstand (v1)
- Ingestion: **kein LLM-Zwang**. v1 verarbeitet Markdown deterministisch, ohne verpflichtende Modellinferenz.
- Garbage Collection: **regelbasiert**, kein LLM in der Konflikt-/Redundanzentscheidung.
- Rückgabe/Reader: **deterministische Volltextausgabe**, kein LLM-Generierungsschritt im Reader selbst.
- LLM-Provider/Modelle sind als dynamische Runtime-Einstellung vorgesehen, aber in v1 ist die Kernpipeline
  bewusst ohne harte LLM-Abhängigkeit gehalten.
